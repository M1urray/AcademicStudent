...
namespace New_Student_Portal.Controllers
{
    public class SupplimentaryController : Controller
    {
        ...
        public ActionResult CourseRegistrationDetails()
        {
            ...
            try
            {
                if (base.Session["Username"] != null)
                {
                    ...
                    string str5 = string.Concat(new string[] { "CourseReg?$filter=StudentNo eq '", str, "' and Programme eq '", registeredProgramme.CurrentProg, "' and Reversed eq false&format=json" });
        ...
        public ActionResult Supplimentary()
        {
            ActionResult action;
            try
            {
