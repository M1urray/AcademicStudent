...
namespace New_Student_Portal.Controllers
{
    ...
    public class ViewDocumentsController : Controller
    {
        ...
        public JsonResult LegacyStatement()
        {
            try
            {
                string message = "";
                ...
                else
                {
                    ...
                    string filename = StudentNo.Replace("/", "") + "-LEG-STATEMENT";
                    Credentials.ObjNav.GenerateStudentLegacyStatement(StudentNo, filename + ".pdf");
                    filename = filename + ".pdf";
                    string DestinationPath = Server.MapPath("~/Downloads/" + filename);
                    CommonClass.MoveFile(filename, DestinationPath);
        ...
        public ActionResult InvitationCard()
        {
            try
            {
                string message = "";
                ...
                else
                {
                    ...
                    string filename = Session["Username"].ToString().Replace("/", "");
                    Credentials.ObjNav.GenerateInvitationCard(RegNo, "INV_CARD-" + filename + ".pdf");
                    filename = "INV_CARD-" + filename + ".pdf";
                    string DestinationPath = Server.MapPath("~/Downloads/" + filename);
                    CommonClass.MoveFile(filename, DestinationPath);
        ...
        public ActionResult ProvisionalResults()
        {
            try
            {
                ...
                else
                {
                    ...
                    string filename = Session["Username"].ToString().Replace("/", "");
                    Credentials.ObjNav.GenerateStudentReportCardFromBackLog(RegNo,"", "PROVISIONAL RESULTS-" + filename + ".pdf");
        ...
        public JsonResult ProformaInvoice()
        {
            try
            {
                ...
                else
                {
                    ...
                    string filename = StudentNo.Replace("/", "");
                    Credentials.ObjNav.GenerateFeesStructure(StudentNo, Sem, "PROFORMA-" + filename + ".pdf");
